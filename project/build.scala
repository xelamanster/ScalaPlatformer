...
object Settings {
  ...
  lazy val desktop = core ++ Seq(
    libraryDependencies ++= Seq(
      ...
      "com.badlogicgames.gdx" % "gdx-box2d-platform" % "1.6.5" classifier "natives-desktop",
  ...
  lazy val android = core ++ Tasks.natives ++ androidBuild ++ Seq(
    libraryDependencies ++= Seq(
      ...
      "com.badlogicgames.gdx" % "gdx-jnigen" % "1.4.1",

      "com.badlogicgames.gdx" % "gdx-box2d-platform" % "1.6.5" % "natives" classifier "natives-armeabi",
      "com.badlogicgames.gdx" % "gdx-box2d-platform" % "1.6.5" % "natives" classifier "natives-armeabi-v7a",
      "com.badlogicgames.gdx" % "gdx-box2d-platform" % "1.6.5" % "natives" classifier "natives-x86",
    ...
    nativeExtractions <<= (baseDirectory) { base => Seq(
      ...
      ("natives-armeabi.jar", new ExactFilter("libgdx-box2d.so"), base / "libs" / "armeabi"),
      ("natives-armeabi-v7a.jar", new ExactFilter("libgdx-box2d.so"), base / "libs" / "armeabi-v7a"),
      ("natives-x86.jar", new ExactFilter("libgdx-box2d.so"), base / "libs" / "x86")
    )},
